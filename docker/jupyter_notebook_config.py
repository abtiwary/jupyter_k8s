...
c.NotebookApp.password = 'notebooks'
...
#  Choices: any of ['sha3_224', 'sha224', 'sha3_384', 'sha1', 'sha512', 'md5', 'sha384', 'blake2s', 'sha3_256', 'sha3_512', 'blake2b', 'sha256']
#  Default: 'sha256'
